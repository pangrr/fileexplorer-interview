...
export const dataFromBackend = {
  ...
  textBlocks: [
    ...
    },
    {
      ...
      text:
        "2) destroy or return to the Disclosing Party all documents and " +
    ...
    },
    {
      ...
      text:
        "3) erase all the Disclosing Party's Confidential Information from its " +
    ...
    },
    {
      ...
      text:
        "4) confirm in writing to the Disclosing Party that it has complied " +
